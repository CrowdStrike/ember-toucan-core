...
export interface ToucanFormControlsFileInputComponentSignature {
  Element: HTMLInputElement;
  Args: {
    /**
     * The "accept" attribute on the underlying input.
    ...
    /**
     * Allows multiple files to be selected when set to true.
     */
    multiple?: boolean;

    /**
     * Called when the user selects files from their file system.
     */
